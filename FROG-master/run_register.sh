...
count=$(ls /home/friot/AutoSegMedSAM2/MedSAM2/amos/imagesRg/ | wc -l)

i=0
#pour toutes les images à segmenter
for f in /home/friot/AutoSegMedSAM2/MedSAM2/amos/imagesTr/*.nii.gz; do
    ...
    python3 tools/register.py -d /home/friot/AutoSegMedSAM2/FROG-master/output -i "$f" -cmin -100 -cmax 500 --orientation "RAS" 
    ...
    mv /home/friot/AutoSegMedSAM2/FROG-master/transforms/$count.json /home/friot/AutoSegMedSAM2/FROG-master/transformsR/$i.json
